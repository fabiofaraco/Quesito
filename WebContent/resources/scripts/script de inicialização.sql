...
ALTER TABLE EVENTOS 
ADD RESPONSABILIDADE_CONINENTE VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD RESPONSABILIDADE_CONTEUDO VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD TRIPULACAO VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD ORIGEM VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD LOCAL_ORIGEM VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD SITUACAO_CHEGADA_SOCORRO VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD ESTABELECIMENTO_MATERIAL VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD SALVAMENTO VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD RETIRADA_CADAVER VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD PROTECAO_BEM VARCHAR(150) NOT NULL;

ALTER TABLE EVENTOS 
ADD ILUMINACAO VARCHAR(150) NOT NULL;
